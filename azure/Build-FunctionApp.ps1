...
.DESCRIPTION
    ...
    block from shared/source/*.ps1 via Build-SharedHelpers.ps1, and writes the assembled result to
...
.DESCRIPTION
    ...
    shared/source/*.ps1.  Do not edit this file directly — edit the source files

...
.DESCRIPTION
    ...
    block from build/shared/source/*.ps1 via build/Build-SharedHelpers.ps1, and writes the assembled result to
...
.DESCRIPTION
    ...
    build/shared/source/*.ps1.  Do not edit this file directly — edit the source files

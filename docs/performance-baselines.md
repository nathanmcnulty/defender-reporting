...
- With that fix in place, the cached-column-reuse lane is useful again as a fast local harness for payload-side tradeoff review because it reproduces the real payload crest without the old post-payload retention blow-up.

...
- Date captured: `2026-05-10` for the AH early-release (`-EarlyReleaseInputData`) hosted fresh-export validation against the stateHash-index baseline; two reruns captured.
